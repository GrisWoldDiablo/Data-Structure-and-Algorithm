...
template<typename T>// can be of any type, needs to implement Less than operator '<'
void BubbleSort(T A[])
{
...
template<typename T> // can be of any type, custom type needs to overload << operator
